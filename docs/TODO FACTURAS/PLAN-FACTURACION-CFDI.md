...
- `01` - Comprobante emitido con errores con relacion (timbrar reemplazo PRIMERO, luego cancelar ligando `uuidReplacement`)
...
- **Regimenes fiscales comunes para doctores**:
  - `612` - Personas Fisicas con Actividades Empresariales y Profesionales (incluye "Servicios Profesionales / Honorarios" — no existe codigo SAT separado para honorarios)
