...
| Clave | Regimen | Notas |
|-------|---------|-------|
| **612** | Personas Fisicas con Actividades Empresariales y Profesionales | Incluye "Servicios Profesionales / Honorarios" — es el mismo codigo. El mas comun para doctores |
...
> **Nota:** No existe un codigo SAT separado para "Regimen de Honorarios" o "Servicios Profesionales". Los doctores que cobran honorarios de forma independiente usan el **612**. El SAT agrupa actividades empresariales y profesionales bajo el mismo regimen.

### Diferencias clave entre 612 (Honorarios/Act. Empresarial) y 626 (RESICO) para facturacion
...
**Nota:** El motivo **01** requiere que la factura de reemplazo se **timbre primero**, y luego se cancela la original ligando el UUID de la nueva.
