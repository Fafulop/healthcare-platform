...
- **612** — Personas Fisicas con Actividades Empresariales y Profesionales (incluye Servicios Profesionales / Honorarios — no existe codigo separado para honorarios en el catalogo SAT)
...
### Regimen 612 — Actividad Empresarial y Profesional / Honorarios

**Fuente:** Art. 103-105 LISR (Titulo IV, Cap. II, Seccion I), Art. 34 LISR (depreciacion)

**Deducciones autorizadas para ISR:**
- Gastos estrictamente indispensables para la actividad (Art. 105 LISR)
- Deben estar amparados con CFDI valido
- Deben estar efectivamente pagados en el ejercicio
- Pagos > $2,000 MXN deben ser bancarizados (Art. 105 LISR)

**Gastos deducibles tipicos para medicos:**

| Categoria | Deducibilidad | Depreciacion | Referencia |
|---|---|---|---|
| Renta de consultorio | 100% | N/A | Art. 103 frac. III |
| Insumos y material medico | 100% | N/A | Art. 103 frac. II |
| Equipo medico | Depreciable | 10% anual (general) | Art. 34 |
| Equipo de computo | Depreciable | 30% anual | Art. 34 |
| Mobiliario | Depreciable | 10% anual | Art. 34 |
| Servicios profesionales | 100% | N/A | Art. 103 frac. III |
| Seguros | 100% | N/A | Art. 103 |
| Servicios basicos | Proporcional | N/A | Solo % uso profesional |
| Capacitacion | 100% | N/A | Art. 103 frac. III |
| Vehiculo | Proporcional/dep. | 25% anual, tope $175k | Art. 34 |
| Nomina | 100% | N/A | Art. 103 |
