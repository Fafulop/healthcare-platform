...
| 6 | [`04-permutaciones-por-flujo-ui.md`](04-permutaciones-por-flujo-ui.md) | **Catálogo por flujo de UI:** para cada acción del doctor (completar cita, Nuevo Movimiento, SAT Registrar, subir estado de cuenta, confirm/Varios/Crear/deshacer, borrar statement, editar/fusionar/vincular en la tabla), sus ramas y el estado resultante. El corte "si hago clic en X, ¿qué pasa?". |
| 7 | [`05-test-log.md`](05-test-log.md) | **Bitácora de pruebas** — tabla consolidada de cada permutación (INC-*/EXP-*) con su estado (LIVE / código / pendiente / gap) y evidencia. El tablero de cobertura de un vistazo. |
| 8 | [`06-agente-motor4-diseno.md`](06-agente-motor4-diseno.md) | **Diseño del agente (Motor 4):** análisis de factibilidad contra el código, niveles de autonomía (qué hace solo vs. con humano), arquitectura de tools/propuestas, flujo de usuario y seguridad. **Nada construido.** |
| 9 | [`STEP-BY-STEP-TESTING.md`](STEP-BY-STEP-TESTING.md) | **Base del ciclo de pruebas** (validada en vivo): cómo borrar un movimiento y regenerarlo desde SAT-descarga, el loop repetible, y los **resultados de pruebas** de egresos (§7). Punto de partida del testing de `01`. |
