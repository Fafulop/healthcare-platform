...
| 8 | [`STEP-BY-STEP-TESTING.md`](STEP-BY-STEP-TESTING.md) | **Base del ciclo de pruebas** (validada en vivo): cómo borrar un movimiento y regenerarlo desde SAT-descarga, el loop repetible, y los **resultados de pruebas** de egresos (§7). Punto de partida del testing de `01`. |
