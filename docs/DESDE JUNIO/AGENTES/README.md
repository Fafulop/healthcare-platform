...
- 🟡 **PARCIALMENTE CERRADO — bitácora #28 (2026-07-27): recortar tools y prosa no basta, falta
  ...
  **fabrica** un análisis a partir de los buckets `sat_emitido`/`sat_recibido` que sobrevivieron en
  ...
  en runtime), así que a diferencia de #25–#27 esta clase **no tiene garantía de máquina**.
  **Fix de payload aplicado el mismo día** — la narración SAT desapareció (0 de 6 corridas) — pero
  queda VIVO el residuo de **sustitución/redirect** (~50%, 3 de 6). Ficha y medición:
  [`AGENTE AGENDA/SESSION-REFRESCO`](AGENTE%20AGENDA/SESSION-REFRESCO.md) bitácora #28 · contexto de
  plan en `../TIERS/01-DISENO-tecnico.md` §11.6.
