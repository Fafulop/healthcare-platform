...
>
> 🔴 **ABIERTO Y SIN FIX — bitácora #28 (2026-07-27, en la tabla de abajo): el PAYLOAD invita la
> narrativa que la prosa prohíbe.** En una cuenta **CORE**, *"¿cómo va mi conciliación bancaria?"* falla **4/4
...
> #25–#27, así que la garantía de máquina que cierra aquéllas NO cubre ésta. Fix propuesto (forma
> de C4) y decisión: **T6**, ver `../../TIERS/01-DISENO-tecnico.md` §11.6 y §12.6.
