...
- [ ] Añadir checkbox de consentimiento explícito en registro/onboarding de médicos
- [ ] Enlace al Aviso en el footer de todas las páginas públicas
- [ ] Política de cookies si se usan GA4, Google Ads, etc.
- [ ] Actualizar `/privacidad` para cumplir con LFPDPPP 2025 (distinguir finalidades con/sin consentimiento, identificar datos sensibles)
...
|---|---|---|
| Sin política de cookies explícita (GA4 activo) | LFPDPPP 2025 | 🟠 Medio |
...
| Política de cookies explícita (GA4 activo) | ⬜ Pendiente | 🟠 **Medio** | LFPDPPP 2025 |
