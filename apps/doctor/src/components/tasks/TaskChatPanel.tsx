...
function MessageBubble({ message }: { message: TaskChatMessage }) {
...
export function TaskChatPanel({
  ...
  }, [messages, isLoading, accumulatedTasks]);
          ...
          <div ref={scrollRef} className="flex-1 overflow-y-auto p-3 space-y-3">
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                ...
                <p className="text-xs text-gray-500 mb-4">
                  Describe las tareas pendientes y se llenaran automaticamente en el formulario. Puedes crear una o varias tareas a la vez.
                </p>
            ...
            {accumulatedTasks.length > 0 && (
              <div className="border-t border-gray-200 pt-3 mt-3">
                <BatchTaskList
                  entries={accumulatedTasks}
                  onUpdateEntries={onUpdateTasks}
                />
                <button
                  type="button"
                ...
                >
                  Crear {accumulatedTasks.length} {accumulatedTasks.length === 1 ? 'Pendiente' : 'Pendientes'}
                </button>
              </div>
            )}
          </div>
          ...
          <div className="border-t border-gray-200 p-2 sm:p-3 bg-white">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                placeholder="Describe las tareas pendientes..."
                disabled={isBusy}
                className={`
