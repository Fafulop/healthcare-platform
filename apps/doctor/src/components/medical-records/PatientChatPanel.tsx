...
import { usePatientChat, type PatientChatMessage, type PatientFormData } from '@/hooks/usePatientChat';

// -----------------------------------------------------------------------------
// Markdown-like renderer (same pattern as PrescriptionChatPanel)
// -----------------------------------------------------------------------------
...
const SUGGESTIONS = [
  'Paciente Juan Perez, masculino, nacido 15 marzo 1985',
  'Alergico a penicilina, diabetico tipo 2, toma metformina',
  'Contacto emergencia: Maria Perez, madre, tel 555-1234',
];
...
function MessageBubble({ message }: { message: PatientChatMessage }) {
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                ...
                <p className="text-sm font-medium text-gray-700 mb-1">
                  Asistente de Registro de Pacientes
                </p>
                <p className="text-xs text-gray-500 mb-4">
                  Describa los datos del paciente y se llenaran automaticamente en el formulario.
                </p>
          ...
          <div className="border-t border-gray-200 p-2 sm:p-3 bg-white">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                placeholder="Describa los datos del paciente..."
                disabled={isBusy}
                className={`
