...
function MessageBubble({ message }: { message: PrescriptionChatMessage }) {
...
interface PrescriptionChatPanelProps {
  onClose: () => void;
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                ...
                <p className="text-xs text-gray-500 mb-4">
                  Describe los medicamentos y datos de la receta y se llenaran automaticamente en el formulario.
                </p>
          ...
          <div className="border-t border-gray-200 p-2 sm:p-3 bg-white">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                placeholder="Describe los medicamentos o datos de la receta..."
                disabled={isBusy}
                className={`
