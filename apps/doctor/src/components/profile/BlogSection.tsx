...
/**
 * Mi Blog — la lista de articulos del doctor.
 *
 * Era una entrada suelta del menu y ahora es tambien una pestana de «Perfil
 * Publico» (2026-09-20): un articulo del blog ES perfil publico, sale en la
 * misma pagina que el doctor ensena.
 *
 * La RUTA `/dashboard/blog` sigue existiendo y usandose: la pestana vive
 * detras del toggle `perfil`, y un member con `blog` pero sin `perfil` seguiria
 * necesitando llegar por URL. Por eso esto es un componente y la ruta es una
 * cascara que lo renderiza — no se duplica nada.
 */
