...
import { useSaleChat, type SaleChatMessage, type SaleFormData, type SaleChatItem } from '@/hooks/useSaleChat';

// -----------------------------------------------------------------------------
// Markdown-like renderer (same pattern as other chat panels)
// -----------------------------------------------------------------------------
...
const SUGGESTIONS = [
  'Venta para paciente Garcia, consulta general a 3000 pesos, pagado',
  'Agrega servicio de limpieza dental a 1500 pesos',
  'Venta de ortodoncia 15000 pesos, pago parcial de 5000',
];
...
function MessageBubble({ message }: { message: SaleChatMessage }) {
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                ...
                <p className="text-xs text-gray-500 mb-4">
                  Describe la venta y se llenara automaticamente el formulario. Incluye paciente, servicios y forma de pago.
                </p>
