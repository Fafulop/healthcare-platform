...
const SUGGESTIONS = [
  'Ingreso de 5000 pesos por consulta, transferencia',
  'Egreso de 1200 pesos por material dental, efectivo',
  'Registra 3 movimientos: consulta 3000, laboratorio 1500, limpieza 800',
];

// -----------------------------------------------------------------------------
// Inline Batch Ledger List
// -----------------------------------------------------------------------------

function BatchLedgerList({
  entries,
  onUpdateEntries,
}: {
  ...
  return (
    <div className="space-y-2">
      <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">
        Movimientos en lote ({entries.length})
      </p>
        ...
        return (
          ...
          >
            ...
            <span className="text-sm font-medium text-gray-900">
              ${entry.amount != null ? Number(entry.amount).toLocaleString('es-MX') : '0'}
            </span>
...
function MessageBubble({ message }: { message: LedgerChatMessage }) {
...
export function LedgerChatPanel({
  ...
  }, [messages, isLoading, accumulatedEntries]);
          ...
          <div ref={scrollRef} className="flex-1 overflow-y-auto p-3 space-y-3">
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                ...
                <p className="text-sm font-medium text-gray-700 mb-1">
                  Asistente de Flujo de Dinero
                </p>
                <p className="text-xs text-gray-500 mb-4">
                  Describe los movimientos y se llenaran automaticamente en el formulario. Puedes crear uno o varios movimientos a la vez.
                </p>
            ...
            {accumulatedEntries.length > 0 && (
              <div className="border-t border-gray-200 pt-3 mt-3">
                ...
                >
                  Crear {accumulatedEntries.length} {accumulatedEntries.length === 1 ? 'Movimiento' : 'Movimientos'}
                </button>
              </div>
            )}
          </div>
          ...
          <div className="border-t border-gray-200 p-2 sm:p-3 bg-white">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                placeholder="Describa los movimientos..."
                disabled={isBusy}
                className={`
