...
import { usePurchaseChat, type PurchaseChatMessage, type PurchaseFormData, type PurchaseItemAction } from '@/hooks/usePurchaseChat';
...
const SUGGESTIONS = [
  'Compra a Dental Corp, 10 cajas de guantes a 150 pesos, pagado',
  'Agrega 5 cajas de resina a 800 pesos cada una',
  'Compra de material: brackets 2000, alambre 500, cemento 350',
];
...
function MessageBubble({ message }: { message: PurchaseChatMessage }) {
...
interface PurchaseChatPanelProps {
  onClose: () => void;
...
export function PurchaseChatPanel({
  onClose,
  currentFormData,
  onUpdateFields,
  onUpdateItems,
}: PurchaseChatPanelProps) {
            ...
            {messages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                ...
                <p className="text-xs text-gray-500 mb-4">
                  Describe la compra y se llenara automaticamente el formulario. Incluye proveedor, productos y forma de pago.
                </p>
          ...
          <div className="border-t border-gray-200 p-2 sm:p-3 bg-white">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                placeholder="Describa la compra..."
                disabled={isBusy}
                className={`
