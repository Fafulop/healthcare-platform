...
import { Mic, Square, Loader2, X, Trash2, CheckSquare, Check, Lock } from 'lucide-react';
...
export function NoteEditor({
  ...
  // TIERS Q2b — el dictado es una de las DOS puertas con candado (plan §9.2):
  // es la función de IA más usada, así que es el mejor upsell. Su gemelo es
  // PatientNoteEditor; los dos se tocan juntos o se rompe la simetría.
