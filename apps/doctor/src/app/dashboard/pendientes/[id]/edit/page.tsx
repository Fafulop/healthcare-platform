...
export default function EditTaskPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Note: dueDate, startTime, endTime are not sent since they can't be edited
      const res = await fetch(`/api/medical-records/tasks/${id}`, {
        method: "PUT",
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">La fecha no se puede modificar</p>
            </div>
            ...
            <p className="text-xs text-gray-500 -mt-2">El horario no se puede modificar</p>
