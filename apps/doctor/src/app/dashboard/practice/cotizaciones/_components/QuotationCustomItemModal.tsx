...
export function QuotationCustomItemModal({
      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
        <div className={`p-6 border-b flex justify-between items-center ${isProduct ? 'bg-purple-50' : 'bg-blue-50'}`}>
          <h3 className="text-xl font-bold text-gray-900">
            {isProduct ? 'Producto Personalizado' : 'Servicio Personalizado'}
          </h3>
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="border-t pt-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl font-bold text-gray-900">${(quantity * price).toFixed(2)}</span>
            </div>
          </div>
