...
import { ArrowLeft, Save, Loader2, Plus, Trash2, FileText, X, Sparkles } from "lucide-react";
...
export default function NewCotizacionPage() {
  ...
  const addProductToQuote = (product: Product) => {
    ...
    const quantity = 1;
    const discountRate = 0; // Default no discount
    const baseAmount = quantity * unitPrice;
    const discountAmount = baseAmount * discountRate;
    const subtotal = baseAmount - discountAmount;
    const taxRate = 0.16; // Default 16%
    const taxAmount = subtotal * taxRate;
