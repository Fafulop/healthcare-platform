          ...
          {currentStep === 7 && (
            <div className="space-y-6">
              ...
              {formData.clinic_locations.map((loc, index) => {
                ...
                return (
                  <div key={index} className="border border-gray-200 rounded-lg p-5 space-y-5">
          ...
          {currentStep === 10 && (
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6 space-y-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-700">Consultorios:</h3>
                  <p className="text-gray-900">{formData.clinic_locations.length} consultorio(s)</p>
                  <p className="text-gray-700 text-sm">{formData.clinic_locations[0]?.address || "No especificado"}</p>
                </div>

                <div>
                  <h3 className="font-semibold text-gray-700">Teléfono:</h3>
                  <p className="text-gray-900">{formData.clinic_locations[0]?.phone || "No especificado"}</p>
                </div>
              </div>
