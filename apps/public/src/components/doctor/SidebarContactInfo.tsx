        ...
        <div className="space-y-2">
          ...
          {clinicInfo.whatsapp && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-3 rounded-lg hover:bg-[var(--color-neutral-light)] transition-colors bg-gradient-to-br from-green-50 to-emerald-50 border border-green-100"
            >
              <div className="flex-shrink-0 w-10 h-10 bg-green-600 bg-opacity-10 rounded-full flex items-center justify-center">
                <MessageCircle className="w-5 h-5 text-green-600" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-xs text-[var(--color-neutral-medium)] font-semibold uppercase tracking-wide">WhatsApp</p>
