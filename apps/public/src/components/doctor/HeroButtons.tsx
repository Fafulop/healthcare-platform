...
export default function HeroButtons({ doctorSlug, whatsappNumber, onBookingClick, googleAdsId }: HeroButtonsProps) {
  ...
  return (
    <div>
      {/* Blog button — mobile only, small, sits in the hero */}
      ...
      <div className="hidden md:flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
        <Button variant="primary" size="lg" className="sm:min-w-[240px] border border-black" onClick={handleBookingClick}>
          Agendar Cita
        </Button>
        <Button variant="secondary" size="lg" className="sm:min-w-[240px] border border-black flex items-center justify-center gap-2" onClick={handleWhatsAppClick}>
